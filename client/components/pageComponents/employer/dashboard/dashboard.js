            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-11">
                <div className="w-full custom-shadow-v1 rounded-lg bg-white p-10 flex items-center justify-between">
                    <div className="w-[70px] h-[70px] rounded-lg bg-blue-100 flex">
                        <IoBriefcaseOutline className="m-auto text-[4rem] text-blue-700" />
                    </div>
                    <div className="text-right">
                        <span className="block text-[2.8rem] font-semibold text-blue-700">{jobsCount}</span>
                ...
                <div className="w-full custom-shadow-v1 rounded-lg bg-white p-10 flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <span className="block text-[2.8rem] font-semibold text-red-700">{candidatesCount}</span>
                        <span className="block text-[1.4rem]">Đơn ứng tuyển</span>
                    </div>
                </div>
                <div className="w-full custom-shadow-v1 rounded-lg bg-white p-10 flex items-center justify-between">
                    <div className="w-[70px] h-[70px] rounded-lg bg-orange-100 flex">
                        <MdOutlineRecommend className="m-auto text-[4rem] text-orange-400" />
                    </div>
                    <div className="text-right">
                        <span className="block text-[2.8rem] font-semibold text-orange-400">{recommendCVsCount}</span>
                ...
                <div className="w-full custom-shadow-v1 rounded-lg bg-white p-10 flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <span className="block text-[2.8rem] font-semibold text-green-700">{notis?.length}</span>
                        <span className="block text-[1.4rem]">Thông báo</span>
                    </div>
                </div>
            </div>
            <div className="mt-10 grid grid-cols-1 xl:grid-cols-3 gap-10">
                <div className="space-y-10 xl:col-span-2 h-fit custom-shadow-v1 rounded-lg bg-white p-10">
                ...
                <div className="xl:col-span-1 custom-shadow-v1 rounded-lg bg-white p-10">
                    <h2 className="text-[1.8rem] font-semibold">Thông báo</h2>
                    <ul className="space-y-5 mt-10 w-full min-h-fit max-h-[430px] overflow-y-auto no-scrollbar">
                        {notis?.length === 0 ? (
